...
class PractitionerSettings(Base):
    ...
    clinic_tagline: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    show_powered_by_go360: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    report_theme: Mapped[Optional[str]] = mapped_column(String(50), default="default", nullable=True)
...
class User(Base):
    ...
    role: Mapped[str] = mapped_column(String(30), default="practitioner", nullable=False)
